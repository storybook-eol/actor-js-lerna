...
dependencies.forEach(function(dependency) {
  ...
  if (!BATCH_MODE) {
    ...
    shell.pullrequest('--branch', 'branchName', '--dependencies-schema', dependencyJSON, '--title-from-schema', '--body-from-schema')
...
if (BATCH_MODE) {
  ...
  shell.pullrequest('--branch', 'batchPrBranchName', '--dependencies-schema', dependencyJSON, '--title-from-schema', '--body-from-schema')
